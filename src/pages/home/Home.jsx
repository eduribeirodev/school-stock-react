...
  // DESESTRUTURANDO O NOVO ESTADO: stockAlerts
  const { dashboardData, stockAlerts, isLoading, error } = useDashboard(); 
...
  // REMOÇÃO DO ARRAY FIXO 'alerts' AQUI

  // Estados de carregamento e erro (MANTIDOS)
  if (isLoading) {
    return (
...
        {/* PASSANDO O NOVO ESTADO DINÂMICO stockAlerts */}
        <DashBoardTable alerts={stockAlerts} /> 
      </section>
