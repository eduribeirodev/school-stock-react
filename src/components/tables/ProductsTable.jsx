...
                        <th className="py-2 text-left font-medium text-gray-500 w-3/12">Produto</th>
                        <th className="py-2 text-left font-medium text-gray-500 w-2/12">Fornecedor</th>
                        <th className="py-2 text-left font-medium text-gray-500 w-2/12">Categoria</th>
...
                                
                                <td className="py-4 font-semibold text-gray-800 w-3/12">
                                    <span className="truncate">{product.product_name}</span>
                                </td>
                                
                                <td className="py-4 text-gray-600 w-2/12">
                                    <span className="truncate">
                                        {product.supplier ? product.supplier.supplier_name : 'N/A'}
                                    </span>
                                </td>
                                
                                <td className="py-4 text-gray-600 w-2/12">
