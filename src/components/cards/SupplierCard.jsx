...
export default function SupplierCard({ title: Title, icon: Icon, p1:P1, quantidade:Qtde }) {
  return (
    <div className="  border border-gray-200  w-[25%]  rounded-xl bg-white/80 place-content-center py-4 shadow-xl">
