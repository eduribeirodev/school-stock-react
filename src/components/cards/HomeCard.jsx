...
export default function HomeCard({ title: Title, icon: Icon, p1:P1, quantidade:Qtde }) {
  return (
    <div className="  border border-gray-200  w-[22%]  justify-around  rounded-xl bg-white/80 place-content-center py-4 shadow-xl">
      
      <div className="flex items-center justify-center">
        <p className=" px-4 text-black/80">{Title}</p>
        <Icon size={16} className="text-2xl text-black/60 p" />
      </div>
      <p className=" flex text-3xl  text-black/80 text-center justify-center py-4  ">
        {Qtde}
      </p>
